...
@Processor(MessageQueue.rabbitSignSendSignatureConfigurationQueue)
export class RabbitSignSendSignatureConfigurationJob {
  constructor(
    private readonly twentyORMGlobalManager: TwentyORMGlobalManager,
  ) {}

  @Process(RabbitSignSendSignatureConfigurationJob.name)
  async handle(
